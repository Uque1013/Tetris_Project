...
//	std::vector<int> temp_location(2);
//	clock_t start;
//
//	// 기본 설정
//	for (i = 0; i < 30; i++)
...
//	put_block(graphic, next_block_coors, temp_location[0], temp_location[1]);
...
//							location[0] = 4;
//							location[1] = 14; // 기준점이 생성되는 점
//							del_block(graphic, block_coors, temp_location[0], temp_location[1]);
